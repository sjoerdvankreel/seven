...
{ 
  ...
  { "{469D130F-2E4A-4960-871D-032B6F588313}", { L"Amt1", L"Amount 1" }, L"%", { 1.0f, 0, real_bounds::unit(), real_bounds::linear(0.0f, 100.0f) }, { false, false, 2, 0, nullptr, 0 } },
  ...
  { "{58AFE21F-7945-4919-BB67-60CE8892A8AF}", { L"Amt2", L"Amount 2" }, L"%", { 1.0f, 0, real_bounds::unit(), real_bounds::linear(0.0f, 100.0f) }, { false, false, 5, 0, nullptr, 0 } },
  ...
  { "{9C1F6472-6D48-42E6-B79E-3A00F33F70F5}", { L"Amt3", L"Amount 3" }, L"%", { 1.0f, 0, real_bounds::unit(), real_bounds::linear(0.0f, 100.0f) }, { false, false, 8, 0, nullptr, 0 } },
  ...
  { "{7A8C3621-D7B9-4D63-9856-DFE2C9396FCD}", { L"Amt4", L"Amount 4" }, L"%", { 1.0f, 0, real_bounds::unit(), real_bounds::linear(0.0f, 100.0f) }, { false, false, 11, 0, nullptr, 0 } },
  ...
  { "{FA974BFF-3DD9-4B42-9FAD-49B9F8196D46}", { L"Amt5", L"Amount 5" }, L"%", { 1.0f, 0, real_bounds::unit(), real_bounds::linear(0.0f, 100.0f) }, { false, false, 14, 0, nullptr, 0 } },
  ...
  { "{645B184E-6AEF-4119-8933-4623749D6280}", { L"Amt6", L"Amount 6" }, L"%", { 1.0f, 0, real_bounds::unit(), real_bounds::linear(0.0f, 100.0f) }, { false, false, 17, 1, nullptr, 0 } },
  ...
  { "{5E433D4A-6E06-46DC-82DA-6F20A6C5652C}", { L"Amt7", L"Amount 7" }, L"%", { 1.0f, 0, real_bounds::unit(), real_bounds::linear(0.0f, 100.0f) }, { false, false, 20, 1, nullptr, 0 } },
  ...
  { "{E5E5897C-0818-49F5-B099-7778760B91A9}", { L"Amt8", L"Amount 8" }, L"%", { 1.0f, 0, real_bounds::unit(), real_bounds::linear(0.0f, 100.0f) }, { false, false, 23, 1, nullptr, 0 } },
  ...
  { "{2A24302A-C793-41AC-BAEE-9BF154C63504}", { L"Amt9", L"Amount 9" }, L"%", { 1.0f, 0, real_bounds::unit(), real_bounds::linear(0.0f, 100.0f) }, { false, false, 26, 1, nullptr, 0 } },
  ...
  { "{02DF43DA-3D49-4571-87FC-F4DF12A0ADBE}", { L"Amt10", L"Amount 10" }, L"%", { 1.0f, 0, real_bounds::unit(), real_bounds::linear(0.0f, 100.0f) }, { false, false, 29, 1, nullptr, 0 } },
  ...
  { "{C1F0E288-FB7F-4762-BA3F-03A2508813B5}", { L"Amt11", L"Amount 11" }, L"%", { 1.0f, 0, real_bounds::unit(), real_bounds::linear(0.0f, 100.0f) }, { false, false, 32, 2, nullptr, 0 } },
  ...
  { "{213502CD-8FEF-45AB-8FDF-69350CC67F72}", { L"Amt12", L"Amount 12" }, L"%", { 1.0f, 0, real_bounds::unit(), real_bounds::linear(0.0f, 100.0f) }, { false, false, 35, 2, nullptr, 0 } },
  ...
  { "{11DC6780-F5F5-4455-90D7-7E387C8F18E0}", { L"Amt13", L"Amount 13" }, L"%", { 1.0f, 0, real_bounds::unit(), real_bounds::linear(0.0f, 100.0f) }, { false, false, 38, 2, nullptr, 0 } },
  ...
  { "{C96385B6-30B7-44BB-9987-30003367804E}", { L"Amt14", L"Amount 14" }, L"%", { 1.0f, 0, real_bounds::unit(), real_bounds::linear(0.0f, 100.0f) }, { false, false, 41, 2, nullptr, 0 } },
  ...
  { "{F6DA01D0-6BFD-4F14-9776-95250FC57CA6}", { L"Amt15", L"Amount 15" }, L"%", { 1.0f, 0, real_bounds::unit(), real_bounds::linear(0.0f, 100.0f) }, { false, false, 44, 2, nullptr, 0 } }
}; 
