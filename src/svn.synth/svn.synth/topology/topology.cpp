...
{  
  ...
  { "{B1D30C73-FF09-452C-A9D5-00BB8B2CE58D}", { L"Dly", L"Delay time" }, L"Sec", { 0.0f, 2, real_bounds::quadratic(0.0f, 10.0f), real_bounds::quadratic(0.0f, 10.0f) }, { 2, 0, envelope_time_relevance, 1 } },
  { "{70C49337-7141-42BC-B336-78B28F4770E3}", { L"Dly", L"Delay sync" }, L"", true, 0, env_synced_timesig_count, 0, format_env_timesig, parse_env_timesig, {2, 0, envelope_sync_relevance, 1}},
  { "{AADD118E-B9CE-464E-83C0-1FAE5A62F530}", { L"Hld", L"Hold time" }, L"Sec", { 0.0f, 2, real_bounds::quadratic(0.0f, 10.0f), real_bounds::quadratic(0.0f, 10.0f) }, { 3, 0, envelope_time_relevance, 1 } },
  { "{AC5D88B7-8CDB-4401-9FB0-20EF0195ABD8}", { L"Hld", L"Hold sync" }, L"", true, 0, env_synced_timesig_count, 0, format_env_timesig, parse_env_timesig, { 3, 0, envelope_sync_relevance, 1 } },
  ...
  { "{E0CFCBB7-B050-4C47-B78C-2511AD2EE6B6}", { L"Att", L"Attack sync" }, L"", true, 0, env_synced_timesig_count, 0, format_env_timesig, parse_env_timesig, { 5, 0, envelope_sync_relevance, 1 } },
  ...
  { "{09B32681-21EF-4C65-B5FD-9FA64ED4AF5E}", { L"Dcy", L"Decay sync" }, L"", true, 0, env_synced_timesig_count, 0, format_env_timesig, parse_env_timesig, { 8, 0, envelope_sync_relevance, 1 } },
  ...
  { "{DDA55E4D-A100-40BA-A7C2-F4C284CACE08}", { L"Rel", L"Release sync" }, L"", true, 0, env_synced_timesig_count, 0, format_env_timesig, parse_env_timesig, { 11, 0, envelope_sync_relevance, 1 } },
