...
static std::vector<std::wstring> const envelope_slopes = { L"Lin", L"Log", L"Quad", L"Sqrt" };
...
{  
  ...
  { "{F468AAD5-B183-4DCB-B6F3-88842FC647F6}", { L"Kind", L"Sync/polarity kind" }, L"", false, &cv_kinds, { false, false, 1, 0, nullptr, 0} },
  ...
  { "{70C49337-7141-42BC-B336-78B28F4770E3}", { L"Dly", L"Delay sync" }, L"", true, &env_timesig_names, { false, false, 2, 2, envelope_sync_relevance, 1}},
  ...
  { "{AC5D88B7-8CDB-4401-9FB0-20EF0195ABD8}", { L"Hld", L"Hold sync" }, L"", true, &env_timesig_names, { false, false, 3, 2, envelope_sync_relevance, 1 } },
  ...
  { "{E0CFCBB7-B050-4C47-B78C-2511AD2EE6B6}", { L"Att", L"Attack sync" }, L"", true, &env_timesig_names, { false, false, 5, 2, envelope_sync_relevance, 1 } },
  { "{1400CEB5-25B1-42B1-ADA1-B5FDF8C6D1E5}", { L"Slp", L"Attack slope" }, L"", false, &envelope_slopes, { false, false, 6, 1, nullptr, 0 } },
  ...
  { "{09B32681-21EF-4C65-B5FD-9FA64ED4AF5E}", { L"Dcy", L"Decay sync" }, L"", true, &env_timesig_names, { false, false, 8, 2, envelope_sync_relevance, 1 } },
  { "{62381FB9-9060-4425-97A6-B57ECB2BECCA}", { L"Slp", L"Decay slope" }, L"", false, &envelope_slopes, { false, false, 9, 1, nullptr, 0 } },
  ...
  { "{DDA55E4D-A100-40BA-A7C2-F4C284CACE08}", { L"Rel", L"Release sync" }, L"", true, &env_timesig_names, { false, false, 11, 2, envelope_sync_relevance, 1 } },
  { "{6B978A93-54D1-4990-BD2E-BC143EA816AF}", { L"Slp", L"Release slope" }, L"", false, &envelope_slopes, { false, false, 12, 1, nullptr, 0 } },
...
{  
  ...
  { "{956F08A1-B3C6-412B-AEEA-55E722744AE8}", { L"Type", L"Type" }, L"", false, &voice_filter_types, { false, false, 0, 2, nullptr, 0 } },
  { "{7498AB5E-4BE6-45B0-8CBF-8D166FF82E32}", { L"Stvr", L"State var type" }, L"", false, &voice_filter_stvar_types, { false, false, 1, 2, vfilter_stvar_relevance, 1 } },
...
{
  { "{2E9F0478-B911-43DF-BB51-0C5836E4853F}", { L"In1", L"Input 1" }, L"", false, &audio_input_names_list, {false, false, 0, 0, nullptr, 0}},
  { "{295DC5F0-FB32-4D43-8799-D79F23FD3AA9}", { L"Out1", L"Output 1" }, L"", false, &audio_output_names_list, { false, false, 1, 0, nullptr, 0 } },
  ...
  { "{A3A59082-CF73-4C28-A3FC-037729C9CB42}", { L"In2", L"Input 2" }, L"", false, &audio_input_names_list, { false, false, 3, 0, nullptr, 0 } },
  { "{843EB41C-199F-4FAC-ACC4-841B3663248D}", { L"Out2", L"Output 2" }, L"", false, &audio_output_names_list, { false, false, 4, 0, nullptr, 0 } },
  ...
  { "{A8E6882A-8945-4F59-92B9-78004EAF5818}", { L"In3", L"Input 3" }, L"", false, &audio_input_names_list, { false, false, 6, 0, nullptr, 0 } },
  { "{D2E34E63-DE9E-4620-924D-1897614BF983}", { L"Out3", L"Output 3" }, L"", false, &audio_output_names_list, { false, false, 7, 0, nullptr, 0 } },
  ...
  { "{89316C97-EB2A-4066-A675-7FCA8A81E908}", { L"In4", L"Input 4" }, L"", false, &audio_input_names_list, { false, false, 9, 1, nullptr, 0 } },
  { "{D76EABE0-2383-4E35-A996-9FAFFF309AD2}", { L"Out4", L"Output 4" }, L"", false, &audio_output_names_list, { false, false, 10, 1, nullptr, 0 } },
  ...
  { "{A87E3D26-1F7F-4D2B-ACA6-CA681126210C}", { L"In5", L"Input 5" }, L"", false, &audio_input_names_list, { false, false, 12, 1, nullptr, 0 } },
  { "{CD659D0E-4818-4D36-9D01-1256C24F8A1F}", { L"Out5", L"Output 5" }, L"", false, &audio_output_names_list, { false, false, 13, 1, nullptr, 0 } },
  ...
  { "{EEDC9213-70B9-4BB6-8D5C-7979D6ABF41F}", { L"In6", L"Input 6" }, L"", false, &audio_input_names_list, { false, false, 15, 1, nullptr, 0 } },
  { "{2437E287-4170-4F98-B179-060FF03D8ACF}", { L"Out6", L"Output 6" }, L"", false, &audio_output_names_list, { false, false, 16, 1, nullptr, 0 } },
  ...
  { "{FABC471B-29FA-45A4-9ACA-6DD21582550F}", { L"In7", L"Input 7" }, L"", false, &audio_input_names_list, { false, false, 18, 2, nullptr, 0 } },
  { "{BD316F66-A86A-46DD-B901-DA3EB0E4CB29}", { L"Out7", L"Output 7" }, L"", false, &audio_output_names_list, { false, false, 19, 2, nullptr, 0 } },
  ...
  { "{61A21B33-F174-4BB8-B70E-D0ABED3AFC32}", { L"In8", L"Input 8" }, L"", false, &audio_input_names_list, { false, false, 21, 2, nullptr, 0 } },
  { "{F52DEACA-9B5C-4D4C-9381-79967288389B}", { L"Out8", L"Output 8" }, L"", false, &audio_output_names_list, { false, false, 22, 2, nullptr, 0 } },
  ...
  { "{EE82872C-0641-48CA-A030-5FCBA09FC0F7}", { L"In9", L"Input 9" }, L"", false, &audio_input_names_list, { false, false, 24, 2, nullptr, 0 } },
  { "{DDD8D342-8ACA-4203-85EC-AA8EEE666A16}", { L"Out9", L"Output 9" }, L"", false, &audio_output_names_list, { false, false, 25, 2, nullptr, 0 } },
...
{  
  { "{CE1DC1C7-72C5-4811-8C35-8485FFAFFABC}", { L"Plot", L"Plot target" }, L"", false, &cv_output_names_list, { true, false, 0, 1, nullptr, 0 } },
  ...
  { "{3B025C6A-0230-491A-A51F-7CF1C81B69C9}", { L"In1", L"Input 1" }, L"", false, &cv_input_names_list, {true, false, 2, 0, nullptr, 0} },
  { "{5FDD8C86-8F2D-4613-BB98-BB673F502412}", { L"Out1", L"Output 1" }, L"", false, &cv_output_names_list, { true, true, 3, 0, nullptr, 0 } },
  ...
  { "{2833E378-210B-404F-A4CB-0D6204A72CF0}", { L"In2", L"Input 2" }, L"", false, &cv_input_names_list, { true, false, 5, 0, nullptr, 0 } },
  { "{D0B28D9E-8888-42EB-8D3C-177FB4585E42}", { L"Out2", L"Output 2" }, L"", false, &cv_output_names_list, { true, true, 6, 0, nullptr, 0 } },
  ...
  { "{25041AB5-2A06-4305-8009-C26D56311D26}", { L"In3", L"Input 3" }, L"", false, &cv_input_names_list, { true, false, 8, 0, nullptr, 0 } },
  { "{37420523-6A9D-4125-BAAB-24A28B9E0992}", { L"Out3", L"Output 3" }, L"", false, &cv_output_names_list, { true, true, 9, 0, nullptr, 0 } },
  ...
  { "{958C1FF6-54BA-4933-9454-125357EE854E}", { L"In4", L"Input 4" }, L"", false, &cv_input_names_list, { true, false, 11, 0, nullptr, 0 } },
  { "{13056333-4562-4D49-9A1E-7EF8FD074956}", { L"Out4", L"Output 4" }, L"", false, &cv_output_names_list, { true, true, 12, 0, nullptr, 0 } },
  ...
  { "{DE0CBCF0-A808-4379-A044-2F4C5CFAC9CF}", { L"In5", L"Input 5" }, L"", false, &cv_input_names_list, { true, false, 14, 0, nullptr, 0 } },
  { "{B043E6E9-2207-4AF7-8AB0-F30B8B722F2C}", { L"Out5", L"Output 5" }, L"", false, &cv_output_names_list, { true, true, 15, 0, nullptr, 0 } },
  ...
  { "{2E34D57F-7277-48D6-9C7E-63897D735005}", { L"In6", L"Input 6" }, L"", false, &cv_input_names_list, { true, false, 17, 1, nullptr, 0 } },
  { "{4E840E8E-ADDD-4C43-A48F-901EEFA616C8}", { L"Out6", L"Output 6" }, L"", false, &cv_output_names_list, { true, true, 18, 1, nullptr, 0 } },
  ...
  { "{11B875C8-815C-48DD-B6FC-4B2F6509D1B6}", { L"In7", L"Input 7" }, L"", false, &cv_input_names_list, { true, false, 20, 1, nullptr, 0 } },
  { "{B0C99125-73D5-493C-B1A4-A145BAF71455}", { L"Out7", L"Output 7" }, L"", false, &cv_output_names_list, { true, true, 21, 1, nullptr, 0 } },
  ...
  { "{A72F92CE-A125-42A1-A1BE-2C45D96F7420}", { L"In8", L"Input 8" }, L"", false, &cv_input_names_list, { true, false, 23, 1, nullptr, 0 } },
  { "{65C29F9C-BC32-4087-94BC-21E524ED2840}", { L"Out8", L"Output 8" }, L"", false, &cv_output_names_list, { true, true, 24, 1, nullptr, 0 } },
  ...
  { "{68B976D6-3C1A-4D6F-B1FD-AEEF8FD95F4B}", { L"In9", L"Input 9" }, L"", false, &cv_input_names_list, { true, false, 26, 1, nullptr, 0 } },
  { "{B7E00C89-2899-4F98-9C1B-C89801D6CFB3}", { L"Out9", L"Output 9" }, L"", false, &cv_output_names_list, { true, true, 27, 1, nullptr, 0 } },
  ...
  { "{0991AAF8-9BB5-4BDF-885A-93231158D717}", { L"In10", L"Input 10" }, L"", false, &cv_input_names_list, { true, false, 29, 1, nullptr, 0 } },
  { "{5D776DFF-11F0-48F0-8F05-2E43589C5556}", { L"Out10", L"Output 10" }, L"", false, &cv_output_names_list, { true, true, 30, 1, nullptr, 0 } },
  ...
  { "{60B208B7-771B-4DFD-B9C0-97E097C340BF}", { L"In11", L"Input 11" }, L"", false, &cv_input_names_list, { true, false, 32, 2, nullptr, 0 } },
  { "{9CC8A1E9-A060-41DC-AA0E-685D9BC65CAF}", { L"Out11", L"Output 11" }, L"", false, &cv_output_names_list, { true, true, 33, 2, nullptr, 0 } },
  ...
  { "{C5F2A2F7-33D0-4B82-903D-82214B938FD2}", { L"In12", L"Input 12" }, L"", false, &cv_input_names_list, { true, false, 35, 2, nullptr, 0 } },
  { "{6C10DABE-1531-4138-AE21-92794637E535}", { L"Out12", L"Output 12" }, L"", false, &cv_output_names_list, { true, true, 36, 2, nullptr, 0 } },
  ...
  { "{570C4799-B355-4EDB-AB38-32AECDE1C07C}", { L"In13", L"Input 13" }, L"", false, &cv_input_names_list, { true, false, 38, 2, nullptr, 0 } },
  { "{DE40B39E-2744-44AD-B9EB-A56ECBEB27FF}", { L"Out13", L"Output 13" }, L"", false, &cv_output_names_list, { true, true, 39, 2, nullptr, 0 } },
  ...
  { "{37EFEDDD-336C-4ACB-A3CB-499D3A2F6427}", { L"In14", L"Input 14" }, L"", false, &cv_input_names_list, { true, false, 41, 2, nullptr, 0 } },
  { "{D0069229-060E-4652-9ECE-CB1474FA791D}", { L"Out14", L"Output 14" }, L"", false, &cv_output_names_list, { true, true, 42, 2, nullptr, 0 } },
  ...
  { "{4DA00E54-7133-4AC4-9B22-286A7F2CD3E7}", { L"In15", L"Input 15" }, L"", false, &cv_input_names_list, { true, false, 44, 2, nullptr, 0 } },
  { "{DF96C8A8-43D8-4515-922D-E7F7F4511AD0}", { L"Out15", L"Output 15" }, L"", false, &cv_output_names_list, { true, true, 45, 2, nullptr, 0 } },
...
{   
  { "{5C9D2CD3-2D4C-4205-893E-6B5DE9D62ADE}", { L"Osc", L"Oscillator" }, part_type::oscillator, false, false, oscillator_count, oscillator_params, oscillator_param::count, oscillator_graphs, oscillator_graph::count, { 0, 3, 0, -1, L"Voice" } },
  { "{FC4885FE-431C-477A-B5B7-84863DB8C07D}", { L"Env", L"Envelope" }, part_type::envelope, false, false, envelope_count, envelope_params, envelope_param::count, &envelope_graph, 1, { 3, 3, 0, -1, L"Voice" } },
  { "{56DE75BB-BE73-4B27-B37F-77F6E408F986}", { L"VLFO", L"Voice LFO" }, part_type::voice_lfo, false, false, voice_lfo_count, voice_lfo_params, voice_lfo_param::count, &voice_lfo_graph, 1, { 1, 3, 0, -1, L"Voice" } },
