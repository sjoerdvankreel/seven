...
audio_route_params[audio_route_param::count] =
{
  ...
  { { L"In", L"Input 4" }, L"", false, 0, audio_inputs_count - 1, 0, &format_audio_input, &parse_audio_input, { 9, 1, nullptr, 0 } },
  { { L"Out", L"Output 4" }, L"", false, 0, audio_outputs_count - 1, 0, &format_audio_output, &parse_audio_output, { 10, 1, nullptr, 0 } },
  { { L"Amt", L"Amount 4" }, L"dB", { 1.0f, 1, real_bounds::unit(), real_bounds::decibel() }, { 11, 1, nullptr, 0 } },
  { { L"In", L"Input 5" }, L"", false, 0, audio_inputs_count - 1, 0, &format_audio_input, &parse_audio_input, { 12, 1, nullptr, 0 } },
  { { L"Out", L"Output 5" }, L"", false, 0, audio_outputs_count - 1, 0, &format_audio_output, &parse_audio_output, { 13, 1, nullptr, 0 } },
  { { L"Amt", L"Amount 5" }, L"dB", { 1.0f, 1, real_bounds::unit(), real_bounds::decibel() }, { 14, 1, nullptr, 0 } },
  { { L"In", L"Input 6" }, L"", false, 0, audio_inputs_count - 1, 0, &format_audio_input, &parse_audio_input, { 15, 1, nullptr, 0 } },
  { { L"Out", L"Output 6" }, L"", false, 0, audio_outputs_count - 1, 0, &format_audio_output, &parse_audio_output, { 16, 1, nullptr, 0 } },
  { { L"Amt", L"Amount 6" }, L"dB", { 1.0f, 1, real_bounds::unit(), real_bounds::decibel() }, { 17, 1, nullptr, 0 } },
  { { L"In", L"Input 7" }, L"", false, 0, audio_inputs_count - 1, 0, &format_audio_input, &parse_audio_input, { 18, 2, nullptr, 0 } },
  { { L"Out", L"Output 7" }, L"", false, 0, audio_outputs_count - 1, 0, &format_audio_output, &parse_audio_output, { 19, 2, nullptr, 0 } },
  { { L"Amt", L"Amount 7" }, L"dB", { 1.0f, 1, real_bounds::unit(), real_bounds::decibel() }, { 20, 2, nullptr, 0 } },
  { { L"In", L"Input 8" }, L"", false, 0, audio_inputs_count - 1, 0, &format_audio_input, &parse_audio_input, { 21, 2, nullptr, 0 } },
  { { L"Out", L"Output 8" }, L"", false, 0, audio_outputs_count - 1, 0, &format_audio_output, &parse_audio_output, { 22, 2, nullptr, 0 } },
  { { L"Amt", L"Amount 8" }, L"dB", { 1.0f, 1, real_bounds::unit(), real_bounds::decibel() }, { 23, 2, nullptr, 0 } },
  { { L"In", L"Input 9" }, L"", false, 0, audio_inputs_count - 1, 0, &format_audio_input, &parse_audio_input, { 24, 2, nullptr, 0 } },
  { { L"Out", L"Output 9" }, L"", false, 0, audio_outputs_count - 1, 0, &format_audio_output, &parse_audio_output, { 25, 2, nullptr, 0 } },
  { { L"Amt", L"Amount 9" }, L"dB", { 1.0f, 1, real_bounds::unit(), real_bounds::decibel() }, { 26, 2, nullptr, 0 } }
};
