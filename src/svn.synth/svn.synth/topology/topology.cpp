...
{  
  ...
  { "{5A57D560-64D2-44D5-BD78-82B7C4BEA79C}", { L"Mid", L"Attack midpoint" }, L"", { 0.5f, 2, real_bounds::unit(), real_bounds::unit() }, { 7, 1, envelope_attack_log_relevance, 1 } },
  ...
  { "{8B5D1F67-DA80-4170-982D-909CC8A025E2}", { L"Mid", L"Decay midpoint" }, L"", { 0.5f, 2, real_bounds::unit(), real_bounds::unit() }, { 10, 1, envelope_decay_log_relevance, 1 } },
  ...
  { "{4E2A6D8B-275C-4E1E-84BE-B21FE16E1E0F}", { L"Mid", L"Release midpoint" }, L"", { 0.5f, 2, real_bounds::unit(), real_bounds::unit() }, { 13, 1, envelope_release_log_relevance, 1 } }
}; 
