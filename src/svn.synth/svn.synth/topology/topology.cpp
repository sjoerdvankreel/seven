...
{
  { "{2E9F0478-B911-43DF-BB51-0C5836E4853F}", { L"In1", L"Input 1" }, L"", false, 0, audio_route_input::count - 1, 0, &format_audio_input, &parse_audio_input, {0, 0, nullptr, 0}},
  { "{295DC5F0-FB32-4D43-8799-D79F23FD3AA9}", { L"Out1", L"Output 1" }, L"", false, 0, audio_route_output::count - 1, 0, &format_audio_output, &parse_audio_output, { 1, 0, nullptr, 0 } },
  { "{A3B15FE9-56DB-493B-A4E1-31A004F3C937}", { L"Amt1", L"Amount 1" }, L"dB", { 1.0f, 1, real_bounds::unit(), real_bounds::decibel() }, { 2, 0, nullptr, 0 } },
  { "{A3A59082-CF73-4C28-A3FC-037729C9CB42}", { L"In2", L"Input 2" }, L"", false, 0, audio_route_input::count - 1, 0, &format_audio_input, &parse_audio_input, { 3, 0, nullptr, 0 } },
  { "{843EB41C-199F-4FAC-ACC4-841B3663248D}", { L"Out2", L"Output 2" }, L"", false, 0, audio_route_output::count - 1, 0, &format_audio_output, &parse_audio_output, { 4, 0, nullptr, 0 } },
  { "{810B55DF-6230-45C7-B478-7A3569DC9127}", { L"Amt2", L"Amount 2" }, L"dB", { 1.0f, 1, real_bounds::unit(), real_bounds::decibel() }, { 5, 0, nullptr, 0 } },
  { "{A8E6882A-8945-4F59-92B9-78004EAF5818}", { L"In3", L"Input 3" }, L"", false, 0, audio_route_input::count - 1, 0, &format_audio_input, &parse_audio_input, { 6, 0, nullptr, 0 } },
  { "{D2E34E63-DE9E-4620-924D-1897614BF983}", { L"Out3", L"Output 3" }, L"", false, 0, audio_route_output::count - 1, 0, &format_audio_output, &parse_audio_output, { 7, 0, nullptr, 0 } },
  { "{6721B1EC-9688-48A3-B5B8-0ADD0A9CF16B}", { L"Amt3", L"Amount 3" }, L"dB", { 1.0f, 1, real_bounds::unit(), real_bounds::decibel() }, { 8, 0, nullptr, 0 } },
  { "{89316C97-EB2A-4066-A675-7FCA8A81E908}", { L"In4", L"Input 4" }, L"", false, 0, audio_route_input::count - 1, 0, &format_audio_input, &parse_audio_input, { 9, 1, nullptr, 0 } },
  { "{D76EABE0-2383-4E35-A996-9FAFFF309AD2}", { L"Out4", L"Output 4" }, L"", false, 0, audio_route_output::count - 1, 0, &format_audio_output, &parse_audio_output, { 10, 1, nullptr, 0 } },
  { "{72593AE1-72BB-408F-819D-3D0C8E632AA8}", { L"Amt4", L"Amount 4" }, L"dB", { 1.0f, 1, real_bounds::unit(), real_bounds::decibel() }, { 11, 1, nullptr, 0 } },
  { "{A87E3D26-1F7F-4D2B-ACA6-CA681126210C}", { L"In5", L"Input 5" }, L"", false, 0, audio_route_input::count - 1, 0, &format_audio_input, &parse_audio_input, { 12, 1, nullptr, 0 } },
  { "{CD659D0E-4818-4D36-9D01-1256C24F8A1F}", { L"Out5", L"Output 5" }, L"", false, 0, audio_route_output::count - 1, 0, &format_audio_output, &parse_audio_output, { 13, 1, nullptr, 0 } },
  { "{B7BABC4D-C3D0-4CD6-A43C-6E63C502C88D}", { L"Amt5", L"Amount 5" }, L"dB", { 1.0f, 1, real_bounds::unit(), real_bounds::decibel() }, { 14, 1, nullptr, 0 } },
  { "{EEDC9213-70B9-4BB6-8D5C-7979D6ABF41F}", { L"In6", L"Input 6" }, L"", false, 0, audio_route_input::count - 1, 0, &format_audio_input, &parse_audio_input, { 15, 1, nullptr, 0 } },
  { "{2437E287-4170-4F98-B179-060FF03D8ACF}", { L"Out6", L"Output 6" }, L"", false, 0, audio_route_output::count - 1, 0, &format_audio_output, &parse_audio_output, { 16, 1, nullptr, 0 } },
  { "{E8016B91-9823-4B4C-AED8-C1F954FC0C70}", { L"Amt6", L"Amount 6" }, L"dB", { 1.0f, 1, real_bounds::unit(), real_bounds::decibel() }, { 17, 1, nullptr, 0 } },
  { "{FABC471B-29FA-45A4-9ACA-6DD21582550F}", { L"In7", L"Input 7" }, L"", false, 0, audio_route_input::count - 1, 0, &format_audio_input, &parse_audio_input, { 18, 2, nullptr, 0 } },
  { "{BD316F66-A86A-46DD-B901-DA3EB0E4CB29}", { L"Out7", L"Output 7" }, L"", false, 0, audio_route_output::count - 1, 0, &format_audio_output, &parse_audio_output, { 19, 2, nullptr, 0 } },
  { "{D765242F-C63B-4B5F-824B-0E8C5E3732EA}", { L"Amt7", L"Amount 7" }, L"dB", { 1.0f, 1, real_bounds::unit(), real_bounds::decibel() }, { 20, 2, nullptr, 0 } },
  { "{61A21B33-F174-4BB8-B70E-D0ABED3AFC32}", { L"In8", L"Input 8" }, L"", false, 0, audio_route_input::count - 1, 0, &format_audio_input, &parse_audio_input, { 21, 2, nullptr, 0 } },
  { "{F52DEACA-9B5C-4D4C-9381-79967288389B}", { L"Out8", L"Output 8" }, L"", false, 0, audio_route_output::count - 1, 0, &format_audio_output, &parse_audio_output, { 22, 2, nullptr, 0 } },
  { "{AAF3C200-9937-4CE2-BB76-DB0FA6FE43AB}", { L"Amt8", L"Amount 8" }, L"dB", { 1.0f, 1, real_bounds::unit(), real_bounds::decibel() }, { 23, 2, nullptr, 0 } },
  { "{EE82872C-0641-48CA-A030-5FCBA09FC0F7}", { L"In9", L"Input 9" }, L"", false, 0, audio_route_input::count - 1, 0, &format_audio_input, &parse_audio_input, { 24, 2, nullptr, 0 } },
  { "{DDD8D342-8ACA-4203-85EC-AA8EEE666A16}", { L"Out9", L"Output 9" }, L"", false, 0, audio_route_output::count - 1, 0, &format_audio_output, &parse_audio_output, { 25, 2, nullptr, 0 } },
