...
{  
  ...
  { "{70C49337-7141-42BC-B336-78B28F4770E3}", { L"Dly", L"Delay sync" }, L"", true, 0, 17 * 16, 0, &format_env_sync, &parse_env_sync, { 2, 0, envelope_sync_relevance, 1 } },
  ...
  { "{AC5D88B7-8CDB-4401-9FB0-20EF0195ABD8}", { L"Hld", L"Hold sync" }, L"", true, 0, 17 * 16, 0, &format_env_sync, &parse_env_sync, { 3, 0, envelope_sync_relevance, 1 } },
  ...
  { "{E0CFCBB7-B050-4C47-B78C-2511AD2EE6B6}", { L"Att", L"Attack sync" }, L"", true, 0, 17 * 16, 0, &format_env_sync, &parse_env_sync, { 5, 0, envelope_sync_relevance, 1 } },
  ...
  { "{09B32681-21EF-4C65-B5FD-9FA64ED4AF5E}", { L"Dcy", L"Decay sync" }, L"", true, 0, 17 * 16, 0, &format_env_sync, &parse_env_sync, { 8, 0, envelope_sync_relevance, 1 } },
  ...
  { "{DDA55E4D-A100-40BA-A7C2-F4C284CACE08}", { L"Rel", L"Release sync" }, L"", true, 0, 17 * 16, 0, &format_env_sync, &parse_env_sync, { 11, 0, envelope_sync_relevance, 1 } },
